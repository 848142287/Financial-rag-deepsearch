...
# Celery配置
celery_broker = os.getenv('REDIS_URL', 'redis://localhost:6394/0')
celery_result_backend = os.getenv('REDIS_URL', 'redis://localhost:6394/0')
...
celery_app = Celery(
    ...
    include=['app.core.async_tasks.tasks', 'app.tasks.vectorized_document_task', 'app.tasks.kg_document_task', 'app.tasks.complete_pipeline_task']
)
