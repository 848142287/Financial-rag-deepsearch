...
class FileParserAdapter:
    ...
    def _register_parsers(self):
        ...
        try:
            ...
            self.registry.register(DocParser(self.config))
            self.registry.register(ExcelParser(self.config))
            self.registry.register(MarkdownParser(self.config))
            self.registry.register(TextParser(self.config))
            self.registry.register(JSONParser(self.config))
            self.registry.register(YAMLParser(self.config))
            self.registry.register(PDFParser(self.config))
