...
from app.services.multimodal.core.multimodal_parser import (
    MultimodalDocumentParser, ParsingConfig, ParsedDocument
)
from app.services.multimodal.evaluators.integrity_evaluator import IntegrityEvaluator
...
async def evaluate_integrity(
    ...
    try:
        # 重构文档对象（简化版本）
        from app.services.multimodal.core.multimodal_parser import Chapter, ContentBlock, ContentType
